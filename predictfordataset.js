...
//var rule=["-","*",3.2982,"*","distancediff",-1.3201,"-","-","-","*","if<=","*",2.1305,"-","-","distance2",-7.2188,-7.2188,"/","distancediff","/",3.3944,"weight1","if<=","distancediff",-6.3424,"goingdiff","-","+","distancediff",2.9134,"*","distancediff",-1.3201,"*","if<=","weight2","distance2","distancediff","*","if<=","-","going2","-","*","if<=","*",3.2982,"*",3.2982,"*","*",3.2982,"*","distancediff",-1.3201,"distancediff",3.3944,"-","distancediff","^","distancediff","+",3.2982,"if<=","distancediff",-6.3424,"goingdiff","-","distancediff","^","^",-7.2188,"-","*",3.2982,"*","distancediff",-1.3201,"-","*","if<=",3.2982,"distancediff","goingdiff",-1.0097,"-","distance2","weight2","if<=","distancediff","*","+","distancediff","if<=","*",3.2982,"*",3.2982,"*","distance1",-1.3201,"distance1","distancediff",9.3158,-7.2188,"-",-7.2188,"-","*","if<=","distancediff","*","-","goingdiff",-7.2188,"if<=","distance2",-7.2188,"/",-8.5752,"weightdiff",5.1233,"goingdiff","weight2","distance2",-1.3201,3.3944,-6.3424,"weight1","-",3.2982,-7.2188,"-","*","weightdiff",3.2982,"going2",-6.3424,"goingdiff","-","distancediff","^","*","distancediff",-1.3201,"+",3.2982,"distancediff","-","distance2",-7.2188,"-","if<=","*",2.1305,"-","distance2",-7.2188,"/","distancediff","*","if<=","*","distancediff",-7.2188,-6.3424,"goingdiff","-","distancediff","^","^",-7.2188,"-","*",3.2982,"*","distancediff",-1.3201,"-","*","if<=","weight2","distancediff","goingdiff",-1.0097,"-","distance2",-1.0097,"*",3.2982,"*","distancediff",-1.3201,-7.2188,"-","distance2",-7.2188,"if<=","distancediff",-6.3424,"goingdiff","distancediff","-","*","+",-7.2188,2.9134,"*",3.2982,"*","distancediff","-","-","-","*","if<=","*","+","distancediff","if<=","*",3.2982,"*","distancediff",-1.3201,"distance1","distancediff",9.3158,-7.2188,-6.3424,"goingdiff","-","distancediff","^","^",-7.2188,"-","*",3.2982,"*","distancediff",-1.3201,"-","*","if<=","weight2","distancediff","goingdiff",-1.0097,"-","distance2",-1.0097,"*",3.2982,"*","distancediff",-1.3201,-6.3424,"-","distance2","distancediff","weight2","*",3.2982,"*","distancediff",-1.3201,"weight2","^","^",-7.2188,"-",-1.3201,-0.0626,"+","if<=","distancediff","distancediff","goingdiff","-","distancediff","*","/","distancediff","/",3.3944,5.9552,"-","distance2","distancediff","if<=","weight1","*",3.2982,"*","distancediff",-1.3201,"going2","distance2",-7.2188,"-","distance2","distancediff","weight2","weight2","weight2"];

var rule=["*","*",-3.7677,"*",-9.6067,"*","goingdiff",-9.6067,"-",6.3901,-0.9028]
